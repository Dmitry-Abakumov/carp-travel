  ...
  return (
    <section className={css.section}>
      <Container className="flex flex-col">
        <h2 className="font-thin text-56px/normal tracking-tighter">
          Choose <span className="font-medium">US</span>
        </h2>
        <p className=" flex self-end font-extralight text-sm max-w-180px mt-6">
          {yourChance}
        </p>
        ...
        <ul className="flex flex-col gap-4 mt-9">
          <li className="text-end max-w-180px">
